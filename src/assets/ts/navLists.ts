      ...
      },
      {
        ...
        chindren: [
          ...
          },
          {
            label: "自测文档",
            value:
              "http://cwiki.guazi.com/pages/viewpage.action?pageId=302880243",
          },
          {
            label: "复盘",
            value:
              "http://cwiki.guazi.com/pages/viewpage.action?pageId=313225456",
          },
          {
            label: "网销听线",
            value:
              "https://cwiki.guazi.com/pages/viewpage.action?pageId=364709164",
          },
          {
            label: "体验优化",
            value:
              "https://cwiki.guazi.com/pages/viewpage.action?pageId=364709159",
          },
          {
            label: "页面搭建",
            value:
              "https://cwiki.guazi.com/pages/viewpage.action?pageId=289362213",
          },
          {
            label: "gaia迭代",
            value:
              "https://cwiki.guazi.com/pages/viewpage.action?pageId=248382716",
          },
          {
            label: "重点项目文档目录",
            value:
              "https://cwiki.guazi.com/pages/viewpage.action?pageId=344735351",
          },
          {
            label: "营销文档",
            value:
      ...
      },
      {
        ...
        chindren: [
          ...
          },
          {
            ...
            value:
              "https://max-kafka-new.guazi-apps.com/topics/detail?tab=data",
          },
          {
            label: "大数据权限申请",
          ...
          },
          {
            label: "新 - 大鱼平台",
            value:
              "https://new-bigfish.guazi-apps.com/testTool/abExperimentTool",
          },
          {
            label: "推荐数据测试工具",
          ...
          },
          {
            label: "回溯系统",
            value:
              "https://trace-platform.guazi-cloud.com/client/highScreening",
          },
          {
            label: "营销平台管理系统",
    ...
    chindren: [
      {
        ...
        chindren: [
          ...
          },
          {
            label: "NGA_FF14",
            value:
              "https://bbs.nga.cn/misc/adpage_insert_2.html?https://bbs.nga.cn/thread.php?fid=-362960",
          },
          {
            label: "WIKI_FF14",
